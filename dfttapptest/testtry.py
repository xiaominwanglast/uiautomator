...
def urlrequest(proxy,times=3):
    ...
    url_one='http://tgtvs.dftoutiao.com/tg.php?channel_id=as_test_1'
    url_two='https://channel.dftoutiao.com/cookie.php?bundleid=com.gaoxin.EastNewsAppstore'
    try:
        rq=session.get(url_one,headers=header,proxies={'http':proxy})
        print rq.headers
