...
def chrome(options):
    while True:
        try:
            ...
            print e
            while(True):
                chromeexe=raw_input(u"驱动崩溃，请更换驱动点击回车键Enter继续测试：".encode('gb18030'))
                if chromeexe=='':
                    break
...
print u"web自动化打包版本V20170228.6".encode('gb18030')
print "-----------------------------------------------------------"
...
print u"！！！新增驱动出现问题后程序挂起不退出，更换chrome驱动后，点击回车键Enter继续测试".encode('gb18030')
print "-----------------------------------------------------------"
time.sleep(2)
